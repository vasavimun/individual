...
export default function PaymentStep({
  ...
  driveLink,
  setDriveLink,
  upiData, // this will come from backend (upiId + paymentCount)
}) {

  /* ------------------------------
     AVAILABLE UPI IDs (BACKEND CONTROLLED)
     Backend should:
     - Track payment count per UPI
     - Once a UPI reaches 20 payments
     - Switch to next available UPI
  -------------------------------- */

  const UPI_IDS = [
    "jainalivela15-1@oksbi",
    "jainalivela15-2@oksbi",
    "bhavana.rachakonda25@okicici",
    "sirisatya18@ibl",
  ];
